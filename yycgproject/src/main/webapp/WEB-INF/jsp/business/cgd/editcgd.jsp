    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('#yycgdmxlist').datagrid({
                ...
                striped: true,
                url: '${baseurl}cgd/queryyycgdmxResult.action',//这里边后边带了一个参数，所以form中不需要此参数yycgdid
...
<body>
<!-- 采购单主信息保存form -->
<form id="yycgdsaveForm" name="yycgdsaveForm" action="${baseurl}cgd/addyycgdmxsubmit.action" method="post">
