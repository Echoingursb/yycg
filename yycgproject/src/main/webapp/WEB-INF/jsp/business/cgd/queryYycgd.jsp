    ...
    <script type="text/javascript">
        ...
        function initGrid() {
            $('#yycgdlist').datagrid({
                ...
                striped: true,
                //collapsible : true,
                url: '${baseurl}cgd/queryYycgdResult.action',
...
<form id="yycgdqueryForm" name="yycgdqueryForm" method="post">
    <TABLE class="table_search">
        ...
        <TR>
            ...
            <td>
                ...
                <!--<input id=""-->
                       <!--type="text"-->
                       <!--name="year"-->
                       <!--onfocus="WdatePicker({isShowWeek:false,skin:'whyGreen',dateFmt:'yyyy',lang:'en', minDate:'2014',maxDate:'%y-%M-%d'})"-->
                       <!--style="width:80px"/>-->
            ...
            <td>
                <input id="yycgdCustom.cjtime_start"
                       ...
                       onfocus="WdatePicker({isShowWeek:false,skin:'whyGreen',dateFmt:'yyyy-MM-dd',lang:'en'})"
                       style="width:80px"/>--
        ...
        <TR>
            ...
            <td>
                <select id="yycgdCustom.yycgdztmc" name="yycgdCustom.zt" style="width:150px">
