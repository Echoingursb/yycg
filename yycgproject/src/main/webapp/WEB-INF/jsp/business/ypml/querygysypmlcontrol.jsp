    ...
    <script type="text/javascript">
        ...
        var columns = [[{
            ...
            formatter: function (value, row, index) {
                return '<input type="hidden" name="gysypmlControlCustoms[' + index + '].ypxxid" value="' + value + '" />';
            }
        }, {
            field: 'usergysid',
            hidden: true,
            formatter: function (value, row, index) {
                return '<input type="hidden" name="gysypmlControlCustoms[' + index + '].usergysid" value="' + row.usergysid + '" />';
            }
        }, {
            field: 'usergysmc',
            title: '供货企业',
            ...
            formatter: function (value, row, index) {
                return '<select  name="gysypmlControlCustoms[' + index + '].control" style="width:80px">'
            ...
            formatter: function (value, row, index) {
                ...
                //var val = value?value:"";
                return '<input type="text" name="gysypmlControlCustoms[' + index + '].advice" value="' + val + '" />';
            }
        }, {
            field: 'bm',
            title: '流水号',
        ...
        function initGrid() {
            $('#gysypmllist').datagrid({
                ...
                striped: true,
                //collapsible : true,
                url: '${baseurl}ypml/querygysypmlcontrolRresult.action',
                //sortName : 'code',
                //sortOrder : 'desc',
                //remoteSort : false,
                //////////////////////////////////////////////////////////////////////////////////////////////
                idField: 'gysypmlcontrolid',//结果集主键，影响选中行的处理
                //////////////////////////////////////////////////////////////////////////////////////////////
...
<div id="ypxxquery_div">
    <form id="gysypmlcontrolForm" name="gysypmlcontrolForm" action="${baseurl}ypml/gysypmlcontrolsubmit.action"
          method="post">
        ...
        <TABLE class="table_search">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="gysypmlControlCustom.usergysmc" id="gysypmlControlCustom.usergysmc"/>
