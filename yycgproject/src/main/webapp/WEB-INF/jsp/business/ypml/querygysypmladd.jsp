    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            dataGrid_obj.datagrid({
                ...
                striped: true,
                //collapsible : true,
                url: '${baseurl}ypml/querygysypmladdResult.action',
                //sortName : 'code',
                //sortOrder : 'desc',
                //remoteSort : false,
...
<div id="ypxxquery_div">
    <form id="gysypmladdqueryForm" name="gysypmladdqueryForm" action="${baseurl}ypml/gysypmladdsubmit.action"
          method="post">
        ...
        <table class="table_search">
            ...
            <tr>
                ...
                <td colspan=2>
                    <a id="btn" href="#" onclick="gysypmladdquery()" class="easyui-linkbutton"
