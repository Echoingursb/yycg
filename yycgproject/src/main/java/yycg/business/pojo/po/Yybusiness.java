...
public class Yybusiness extends BusinessBasePo{
    private String id;
    ...
    public void setYythdid(String yythdid) {
        this.yythdid = yythdid == null ? null : yythdid.trim();
    }
    ...
    public void setThzt(String thzt) {
        this.thzt = thzt == null ? null : thzt.trim();
    }
    ...
    public void setYyjsdid(String yyjsdid) {
        this.yyjsdid = yyjsdid == null ? null : yyjsdid.trim();
    }
